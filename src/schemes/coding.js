/**
 * coding 方案
 * 按钮：加粗、斜体、下划线、删除线、链接、去链接、前景色、背景色、无序列表、有序列表、图片
 * 按钮：格式、左对齐、居中对齐、右对齐、横线、清除格式、撤销、重做、全屏
 * 右键：加粗、斜体、下划线、删除线、链接
 * @author ydr.me
...
module.exports = {
    toolbar: [
        ...
        'formatselect alignleft aligncenter alignright hr removeformat undo redo fullscreen'
    ],
