 ...
 */
    ...
    EditorManager = {
        ...
        ui: {
            ...
            AbsoluteLayout: require('./ui/AbsoluteLayout'),
            Button: require('./ui/Button'),
            ButtonGroup: require('./ui/ButtonGroup'),
            Container: require('./ui/Container'),
            Checkbox: require('./ui/Checkbox'),
            ComboBox: require('./ui/ComboBox'),
            ColorBox: require('./ui/ColorBox'),
            Panel: require('./ui/Panel'),
            PanelButton: require('./ui/PanelButton'),
            ColorButton: require('./ui/ColorButton'),
            ColorPicker: require('./ui/ColorPicker'),
            Path: require('./ui/Path'),
            FormItem: require('./ui/FormItem'),
            Form: require('./ui/Form'),
            FieldSet: require('./ui/FieldSet'),
            FilePicker: require('./ui/FilePicker'),
            FitLayout: require('./ui/FitLayout'),
            FlexLayout: require('./ui/FlexLayout'),
            FlowLayout: require('./ui/FlowLayout'),
            FloatPanel: require('./ui/FloatPanel'),
            GridLayout: require('./ui/GridLayout'),
            Iframe: require('./ui/Iframe'),
            Label: require('./ui/Label'),
            Toolbar: require('./ui/Toolbar'),
            MenuBar: require('./ui/MenuBar'),
            MenuButton: require('./ui/MenuButton'),
            MenuItem: require('./ui/MenuItem'),
            Menu: require('./ui/Menu'),
            ListBox: require('./ui/ListBox'),
            Radio: require('./ui/Radio'),
            ResizeHandle: require('./ui/ResizeHandle'),
            SelectBox: require('./ui/SelectBox'),
            Slider: require('./ui/Slider'),
            Spacer: require('./ui/Spacer'),
            SplitButton: require('./ui/SplitButton'),
            StackLayout: require('./ui/StackLayout'),
            Factory: require('./ui/Factory'),
            FormatControls: require('./ui/FormatControls'),
            ElementPath: require('./ui/ElementPath'),
            TabPanel: require('./ui/TabPanel'),
            TextBox: require('./ui/TextBox'),
            Throbber: require('./ui/Throbber')
        },
        geom: {
            Rect: require('./geom/Rect')
        },
        Env: require('./Env'),
        DOM: require('./dom/DOMUtils').DOM,
        util: {
    ...
    extend(EditorManager, require('./util/Tools'));
    extend(EditorManager, require('./util/Observable'));
    EditorManager.setup();
