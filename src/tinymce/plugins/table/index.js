 ...
 */
    ...
    var TableGrid = require("./classes/TableGrid");
    var Quirks = require("./classes/Quirks");
    var CellSelection = require("./classes/CellSelection");
    var Dialogs = require("./classes/Dialogs");
    var ResizeBars = require("./classes/ResizeBars");
    var Tools = require("../../classes/util/Tools");
    var TreeWalker = require("../../classes/dom/TreeWalker");
