...
PluginManager.add('auto-resize', function (editor) {
    ...
    settings.autoresize_max_height = parseInt(editor.getParam('autoresize_max_height', settings.max_height), 10);
    ...
    editor.on("init", function () {
        ...
        bottomMargin = editor.getParam('autoresize_bottom_margin', 1);
